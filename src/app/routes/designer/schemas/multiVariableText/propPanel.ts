...
const mapDynamicVariables = (props: PropPanelWidgetProps) => {
  ...
  if (varNames.length > 0) {
    ...
    para.innerHTML = i18n("schemas.mvt.typingInstructions") + ` <code style="color:${options?.theme?.token?.colorPrimary || "#168fe3"}; font-weight:bold;">{` + i18n("schemas.mvt.sampleField") + "}</code>";
