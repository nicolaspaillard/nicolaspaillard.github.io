...
import { DEFAULT_ALIGNMENT, DEFAULT_CHARACTER_SPACING, DEFAULT_FONT_COLOR, DEFAULT_FONT_SIZE, DEFAULT_LINE_HEIGHT, DEFAULT_VERTICAL_ALIGNMENT, PLACEHOLDER_FONT_COLOR, VERTICAL_ALIGN_BOTTOM, VERTICAL_ALIGN_MIDDLE, VERTICAL_ALIGN_TOP } from "./constants.js";
import { calculateDynamicFontSize, getBrowserVerticalFontAdjustments, getFontKitFont, isFirefox } from "./helper.js";
...
export const uiRender = async (arg: UIRenderProps<TextSchema>) => {
  ...
  const [fontKitFont, textBlock] = await Promise.all([getFontKitFont(schema.fontName, font, _cache), buildStyledTextContainer(arg, usePlaceholder ? placeholder : value)]);
